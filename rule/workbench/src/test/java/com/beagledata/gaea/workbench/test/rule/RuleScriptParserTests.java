...
import com.beagledata.gaea.workbench.rule.parser.RuleScriptParser;
...
public class RuleScriptParserTests {
    ...
    @Test
    public void test() {
        Assets assets = assetsMapper.selectByUuid("eab3c89d5a514911aa0b165ef0c6786e");
        String rule = new RuleScriptParser(assets).getDumper().dump();
