<template>
  <div>
      <el-form inline :model="form" ref="form">
        <el-form-item label="登录地址" class="timePickIn" prop="clientIp">
      ...
      <el-table v-loading="tableLoading" element-loading-text="数据加载中..." :data="logs" align="center">
        <el-table-column prop="clientIp" label="登录地址"></el-table-column>
        <el-table-column prop="beginTime" label="登录时间"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      loadUserLos() {
        ...
        this.$axios.get("/user/login/logs", {params}).then(res => {
